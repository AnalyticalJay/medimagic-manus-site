        ...
        <ScrollAnimationWrapper animationType="fade-in">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              ...
              <div className="bg-[#1a3a52] p-6 rounded-lg border-2 border-[#5DBB63] text-white shadow-lg hover:shadow-xl transition-all flex flex-col items-center">
                <div className="mb-4 flex justify-center">
                  <img src="https://d2xsxph8kpxj0f.cloudfront.net/310519663346956907/m34URbdUs5hQJ7HCnuFYLq/flexible-schedule-icon-transparent-cVTgRUdhsxwSkVKHVyRyL6.webp" alt="Flexible to Your Schedule" className="h-24 w-auto" />
                </div>
