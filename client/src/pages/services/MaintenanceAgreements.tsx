...
import { ArrowLeft, Check, AlertCircle, Heart, TrendingUp, Menu, X, ChevronDown } from "lucide-react";
    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <section className="py-12 md:py-20 px-4 sm:px-6 lg:px-8 bg-[#1a3a52]">
        <div className="container max-w-4xl text-center">
          <h2 className="text-3xl font-bold text-white mb-6">Protect Your Children's Financial Future</h2>
